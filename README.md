...
Students must help different characters in the _Animal Crossing_ universe sort their files and shop inventory. The goal of this assignment is for students to understand and implement recursive sorting and searching algorithms such as Merge Sort, Quick Sort, and Recursive Binary Search.
...
* Displays Animal-Crossing-inspired GUI written in Swing (```Driver.java```)
    ...
    * The array/ArrayList of objects is illustrated with each element as its own box
        ...
        * Catalog item boxes display the item's price
...
&nbsp;
![Merge Sort screen displaying an unsorted Creature array](/snapshots/blathersUnsortedScreen.png)
&nbsp;
![Quick Sort screen displaying an unsorted CatalogItem ArrayList](/snapshots/nooksUnsortedScreen.png)
&nbsp;
![Recursive Binary Search screen displaying a sorted CatalogItem ArrayList and a value to search](/snapshots/recursiveBinSearchScreen.png)
